...
import { PublicOrgHeaderProvider } from "@/hooks/public-org-header-context";
 ...
 * handed to usePublicOrgContext (via PublicOrgHeaderProvider) which prefers
...
export default async function PublicLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <PublicOrgHeaderProvider organizationId={organizationId}>
      <PublicLayoutClient>{children}</PublicLayoutClient>
    </PublicOrgHeaderProvider>
  );
}
