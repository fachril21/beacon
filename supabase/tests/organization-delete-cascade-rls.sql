...
insert into public.spaces (id, organization_id, name, is_publishable, created_by_user_id)
...
insert into public.pages (id, space_id, title, content, visibility, is_published, created_by_user_id)
...
update public.organizations set name = 'Org One Renamed' where id = 'e0000000-0000-0000-0000-00000000000e';

select name as expect_renamed from public.organizations where id = 'e0000000-0000-0000-0000-00000000000e';
...
update public.organizations set name = 'Hacked Name' where id = 'e0000000-0000-0000-0000-00000000000e';

select name as expect_still_renamed_not_hacked from public.organizations where id = 'e0000000-0000-0000-0000-00000000000e';
...
update public.organizations set name = name where id = 'e0000000-0000-0000-0000-00000000000e'; -- no-op, keep role context
delete from public.organizations where id = 'e0000000-0000-0000-0000-00000000000e';

select count(*)::int as expect_one_org_still_exists from public.organizations where id = 'e0000000-0000-0000-0000-00000000000e';
...
reset role;
select count(*)::int as expect_zero_orgs from public.organizations where id = 'e0000000-0000-0000-0000-00000000000e';
select count(*)::int as expect_zero_spaces from public.spaces where id = 'b0000000-0000-0000-0000-00000000000b';
select count(*)::int as expect_zero_pages from public.pages where id = 'c0000000-0000-0000-0000-00000000000c';
select count(*)::int as expect_zero_permissions from public.permissions where space_id = 'b0000000-0000-0000-0000-00000000000b';
select count(*)::int as expect_zero_memberships from public.organization_memberships where organization_id = 'e0000000-0000-0000-0000-00000000000e';
